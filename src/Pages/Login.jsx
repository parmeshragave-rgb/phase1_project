...
class Login extends Component {
  ...
  toggleMode = () => {
    this.setState((prev) => ({ isLogin: !prev.isLogin, message: "" }));
  };
  ...
  render() {
    ...
    return (
      ...
      >
        <Paper elevation={6} sx={{  p: 4,  width: "100%",maxWidth: 400,textAlign: "center",borderRadius: 3,
          }}
        >
          ...
          <form onSubmit={this.handleSubmit}>
            <Stack spacing={2}>
              ...
              <Button
                ...
                type="submit"
                fullWidth
                sx={{ borderRadius: "50px",bgcolor:"#00004d",fontFamily:"sans-serif",color:"whitesmoke"}}
              >
                {isLogin ? "Login" : "Sign Up"}
              </Button>
            </Stack>
